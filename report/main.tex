...
\begin{minipage}{\textwidth}
  ...
  \begin{table}[H]
    ...
    \begin{tabular}{ccccccr}
      ...
      A & 2  & 0  & 1  & $\frac{2}{2}$ & $\frac{2}{2+1}$ & $\frac{2}{1 + \frac{3}{2}} = 0.80 $ \\
      B & 4 & 0 & 0    & $\frac{4}{4}$ & $\frac{4}{4}$ & $\frac{2}{1 + 1} = 1.00 $ \\
      C & 5 & 1 & 0    & $\frac{5}{5+1}$ & $\frac{5}{5}$ & $\frac{2}{\frac{6}{5} + 1} \approx \textbf{0.91}$ \\
    \end{tabular}
  \end{table}
...
testing accuracy of 76.% and a training accuracy of 84%
